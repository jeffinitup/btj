...
public class GuiPetitionList extends GuiSlot {
    private static ResourceLocation namesPath = BetterThanJosh.idOf("texts/signees.txt");

    private Minecraft mc;
    private GuiPetition credits;
    private FontRenderer fontRenderer;
    private List<String> names;

    public GuiPetitionList(GuiPetition credits, Minecraft mc, FontRenderer fr) throws IOException {
